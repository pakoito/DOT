...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QClickablePixmapGraphicsItem_t, stringdata) + ofs \
...
void *QClickablePixmapGraphicsItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "org.qt-project.Qt.QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< QClickablePixmapGraphicsItem*>(this));
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QButtonGraphicsItem_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
QT_MOC_LITERAL(4, 34, 3)
    ...
    "QButtonGraphicsItem\0clicked\0\0hide\0pos"
};
#undef QT_MOC_LITERAL
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPieMenu_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
QT_MOC_LITERAL(13, 132, 17)
    ...
    "showMenuNow\0bgClicked\0checkActiveWindow"
};
#undef QT_MOC_LITERAL
