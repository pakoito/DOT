...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TreeWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 48, 9)
    ...
    "TreeWidget\0OnClick\0\0hideEvent\0QHideEvent*\0"
    "event\0CreateNew"
};
...
void TreeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->hideEvent((*reinterpret_cast< QHideEvent*(*)>(_a[1]))); break;
...
const QMetaObject TreeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TreeWidget.data,
      qt_meta_data_TreeWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TreeWidget.stringdata))
